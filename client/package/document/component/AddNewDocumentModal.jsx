...
const AddNewDocumentModal = ({ closeModal, style }) => {
  ...
  const handleUpload = async (values, actions) => {
    ...
    try {
      ...
      data.getAll("multipartFile", "title", "note", "mark");
  ...
  return (
                        ...
                        <div className="p-3 bg-white h-full w-full flex">
                          <div className="w-1/2 border shadow-md pr-3 overflow-hidden">
                            <SinglePdfPage
                              ...
                              revmoveDocument={() => revmoveDocument()}
                            />
                          </div>
                            ...
                            <div className="mb-4">
                              ...
                              <div className="relative">
                                <Field
                                  ...
                                  className={
                                    "appearance-none border-2 rounded-md w-full p-3 text-gray-700 leading-tight focus:outline-none text-sm " +
                                    (props.errors.mark && props.touched.mark
                                      ? "border-red-500"
                                      : "border-green-500")
                                  }
                                  type="number"
    ...
    <CompareFileModal style={isSimilar} value={dataSimilar} closeModal={()=>setIsSimilar(false)} />
    </>
